...
# 1 "states/../menuScreens/uiTiles.h" 1
# 21 "states/../menuScreens/uiTiles.h"
extern const unsigned short uiTilesTiles[160];


extern const unsigned short uiTilesPal[256];
# 10 "states/start.c" 2
# 1 "states/../menuScreens/mainMenuBG.h" 1
# 22 "states/../menuScreens/mainMenuBG.h"
...
void initStart() {
    ...
    DMANow(3, &mainMenuBGTiles, &((CB*) 0x6000000)[1], 7872 / 2);
    DMANow(3, &mainMenuBGPal, ((unsigned short *)0x5000000), 512 / 2);
    DMANow(3, &mainMenuBGMap, &((SB*) 0x6000000)[17], 2048 / 2);
}
