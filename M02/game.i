...
# 1 "states/../levels/levelManager.h" 1
...
# 1 "states/../player/player.h" 1



# 1 "states/../player/../helpers/gba.h" 1
# 5 "states/../player/player.h" 2
...
# 1 "states/../enemies/enemyManager.h" 1



# 1 "states/../enemies/../helpers/gba.h" 1
# 5 "states/../enemies/enemyManager.h" 2
...
# 1 "states/../art/spritesheet.h" 1
# 21 "states/../art/spritesheet.h"
extern const unsigned short spritesheetTiles[16384];


extern const unsigned short spritesheetPal[256];
# 18 "states/game.c" 2
# 1 "states/../gameBgs/gametileset.h" 1
# 21 "states/../gameBgs/gametileset.h"
extern const unsigned short gametilesetTiles[16384];


extern const unsigned short gametilesetPal[256];
# 19 "states/game.c" 2
# 1 "states/../gameBgs/redBG.h" 1
# 22 "states/../gameBgs/redBG.h"
...
void updateGame() {
    if ((!(~(oldButtons) & ((1<<3))) && (~(buttons) & ((1<<3))))) { enterState(GS_PAUSE); }
...
void drawMaps() {
    DMANow(3, &gametilesetPal, ((unsigned short *)0x5000000), 512 / 2);
    DMANow(3, &gametilesetTiles, &((CB*) 0x6000000)[1], 32768 / 2);


    DMANow(3, &redBGTiles, &((CB*) 0x6000000)[0], 13824 / 2);
    DMANow(3, &redBGMap, &((SB*) 0x6000000)[16], 2048 / 2);
...
void drawMovingBG() {
    ...
    (*(volatile unsigned short*) 0x04000010) = hOff_scroll;
    (*(volatile unsigned short*) 0x04000012) = vOff_scroll;
}
